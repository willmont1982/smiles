(function($) {
	...
	$termsAccepted          : $('.btn-primary'),
	$termsOpened            : $('.btn-primary'),
	...
	init : function() {
		...
		// função habilitar/desabilitar botão caso checked igual true
	...
	addListeners: function(){
		...
		$('.btn-confirm').on('click',function() {
            SmilesFamilyAccount.FamilyAccountController.$termsAccepted = true;
            SmilesFamilyAccount.FamilyAccountController.$termsOpened = true;
			SmilesFamilyAccount.FamilyAccountController.changeMember();
			return;
		});
	...
	createRules : function() {
		...
		if(this.validateCreateFields) {
			...
			this.cardRule[++i] = {'rule':'termsOfUseCheck','value': this.$termsOpened.is(':checked') ,'type':'boolean'};
			this.cardRule[++i] = {'rule':'termsOfUseCheck','value': this.$termsAccepted.is(':checked') ,'type':'boolean'};
		}
	...
	applicationCreateRule : function() {
		...
		$.each(SmilesFamilyAccount.FamilyAccountController.cardRule, function(value, item) {
			...
			else if(SmilesFamilyAccount.FamilyAccountController.cardRule[value].rule =='termsAccepted'){
				if(SmilesFamilyAccount.FamilyAccountController.#termsAccepted !== null && SmilesFamilyAccount.FamilyAccountController.$termsAccepted.is(':checked')){
					smiles.portal.CommomValidators.controller.Makefield(SmilesFamilyAccount.FamilyAccountController.$termsAccepted);
				}
			}
		  }else if (SmilesFamilyAccount.FamilyAccountController.cardRule[value].rule =='termsOpened'){
			if(SmilesFamilyAccount.FamilyAccountController.#termsOpened !== null SmilesFamilyAccount.FamilyAccountController.$termsOpened.is(':checked')){
				smiles.portal.CommomValidators.controller.Makefield(SmilesFamilyAccount.FamilyAccountController.$termsOpened);
			}
		}
				...
				if(SmilesFamilyAccount.FamilyAccountController.$greeTerms !== null && SmilesFamilyAccount.FamilyAccountController.$greeTerms.is(':checked')) {
